...
import { LoggerService, Types } from './types';
...
const DEFAULT_LOG_LEVELS: Types[] = [
  'log',
  'error',
  'warn',
  'debug',
...
export class ConsoleLogger implements LoggerService
{
  ...
  isLevelEnabled(level: Types): boolean
  {
  ...
  protected stringifyMessage(message: unknown, logLevel: Types): string
  {
  ...
  protected colorize(message: string, logLevel: Types)
  {
  ...
  private getColorByLogLevel(level: Types)
  {
    switch (level)
    {
      case 'debug':
